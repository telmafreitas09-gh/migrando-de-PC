...
import { LgpdRegisterConsent } from '@/components/lgpd-register-consent'
...
export default function LoginPage() {
  ...
  function handleRegister() {
    if (!acceptPrivacy) {
      toast.error('Você precisa aceitar a Política de Privacidade para se cadastrar.')
      return
    }
        ...
        <div className="w-full max-w-sm">
          ...
          {mode === 'register' && (
            <div className="space-y-4">
              ...
              <LgpdRegisterConsent checked={acceptPrivacy} onChange={setAcceptPrivacy} />
